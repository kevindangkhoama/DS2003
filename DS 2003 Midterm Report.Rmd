...
---
# Executive Summary
This report utilizes NBA data to create clear and informative plots that demonstrate differences in NBA seasons and positions. The demographic of this report caters to readers looking to understand how different players perform in the playoffs v.s. the regular season and the durability of a player in the NBA in their respective playing position. Stakeholders interested in this may be recruiters, coaches, or fantasy league players.

Our key findings were that though the average performance between players was close, players tended to play slightly worse in the regular season than in the playoffs. There are many reasons for this, one being that the playoffs are more significant in a player's legacy. Furthermore, the playoffs contain fewer games than the regular season. We also found that the positions of power-forward and centers played the most games but had the least playing time per game. We found this interesting and thought it was valuable insight for coaches to know as they plan substitutes.
...
As a group, we found that we all had a common interest in basketball, especially with March Madness approaching. We tried looking for data sets involving the NCAA and UVA men's basketball but weren't able to find data sets containing enough entries and categories. Additionally, it is simple to find stats tracking the performance of players in sports. Knowing this, we explored some datasets on Kaggle and found an interesting one that included NBA stats on playoffs and regular seasons from 2021-2022.

We thought it would be interesting to see how a player's performance differs between the playoffs and regular seasons. The regular season determines placement in the playoffs, but we felt it was important to see how players stepped up to the pressure of being in the playoffs and winning when it mattered. This led us to wonder if there was a difference between a player’s position and how long they can remain in the league. For example, players who play a guard position are usually shorter than those who play a center position. In general, taller NBA players seem to be less durable, and we wanted to see if this was true.
...
### Narrative
PROOF READ: We thought that it would be good to see what positions played the most games per season to test durability. While this was a good graph we also were curious about the minutes played per game, due to the fact that someone may play a lot of games despite playing few minutes per game. These two box plots did present interesting data as Shooting Guard-Point Guard position was a position that played a lot of games per season on average compared to many others, but despite that the median amount of minutes played per game was much closer to other positions medians. This data could have big implications on the stakeholders (the NBA coaches). These graphs can tell the coaches that although some positions could be the most important part of a team, a team may also want the most substitutions for those respective positions as they are the least durable/can handle less play time throughout a single game.

# Summary
PROOF READ: Overall, our graphs do provide information about player performance from the playoffs and regular season and inform stakeholders about discrepancies between games played and play time for the various positions. Upon viewing the facet-wrapped scatter plot graph, we see that generally players in general perform around or just slightly below their averages from the regular season onto the playoff season. Since these values are so close, the graph would likely support a claim that individual player performance does not change much between the playoffs and regular season. From our boxplots, we can see how the median and interquartiles for games played and minutes played per game change between positions. This graphical representation can help coaches determine which positions are really vital, in that they play many games and for long periods; where people get the most exhausted and may need substitutes; and give insight into which positions have players in for different amounts of time than the number of games played would suggest. This is important to the game because all of these insights could be useful for strategizing.
